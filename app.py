...
st.title("🚛 Truck Route Planner - Real Routing (Cloud Safe)")
...
def get_coords_from_ors(address):
...
if st.button("Generate Truck Route"):
    start_coords = get_coords_from_ors(start)
    end_coords = get_coords_from_ors(end)
    ...
    if not start_coords or not end_coords:
        ...
        if route_data:
            ...
            route_coords = [[lat, lon] for lon, lat in coords]  # Flip for folium
